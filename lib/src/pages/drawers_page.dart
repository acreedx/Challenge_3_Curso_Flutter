...
class _DrawersPageState extends State<DrawersPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //end drawer para ponerlo al final
      drawer: Drawer(
        child: Column(children: [
          UserAccountsDrawerHeader(
              accountName: Text("Gabriel Herrera"),
              accountEmail: Text("gabrielhlinares@gmail.com"),
            ...
            otherAccountsPictures: [
              CircleAvatar(
                backgroundImage: Image(image: AssetImage("images/profilepic.jpg")).image,
              ),
              CircleAvatar(
                backgroundImage: Image(image: AssetImage("images/profilepic.jpg")).image,
              ),
